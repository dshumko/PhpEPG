...
$socket = stream_socket_server("udp://192.168.2.110:65224", $errno, $errstr, STREAM_SERVER_BIND);
if (!$socket) {
    echo "shudas!!!";
    die("$errstr ($errno)");
}
...
$failas_sched = fopen("/var/tv24_epg/eit_04.ts", "rb");
$failas_now = fopen("/var/tv24_epg/now_04.ts", "rb");
...
//if ($failas == 0)break;
		...
		usleep(30000);//30000
		stream_socket_sendto($socket, $paketas, 0, "239.1.3.4:1234");//239.1.1.9:1234
//		fwrite ($tsts, $paketas);
